              ...
              children: [
                UserAccountsDrawerHeader(
                  accountName: const Text(
                    'Diva Maharachmi Kapitanhitu',
                    style: TextStyle(
                        color: Colors.white, fontWeight: FontWeight.bold),
                  ),
                  accountEmail: const Text('kapitanhitudiva@gmail.com',
                  ...
                  decoration: const BoxDecoration(
                      ...
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: NetworkImage(
                              'https://4kwallpapers.com/images/wallpapers/dusk-landscape-4400x2475-10271.jpg'))),
                ),
                ListTile(
                ...
                ListTile(
                  ...
                  onTap: () async {
                    final Uri url =
                        Uri.parse('https://www.instagram.com/divaaa.k__/');
                    if (await canLaunchUrl(url)) {
                      await launchUrl(url,
                          mode: LaunchMode.externalApplication);
                    } else {
                ...
                ListTile(
                  ...
                  onTap: () async {
                    final Uri url = Uri.parse(
                        'https://www.facebook.com/share/18aiS82c3N/?mibextid=LQQJ4d');
                    if (await canLaunchUrl(url)) {
                      await launchUrl(url,
                          mode: LaunchMode.externalApplication);
                    } else {
